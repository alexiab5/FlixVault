...
export default function EditReview() {
  ...
  useEffect(() => {
    console.log(`Edit page loaded for review ID: ${id}`);
    
    const loadReview = async () => {
      try {
        setIsLoading(true);
        console.log("Attempting to load review data...");
        ...
        console.log("getReviewById result:", foundReview);
  ...
  const handleSave = async () => {
    try {
      ...
      if (review) {
        ...
        console.log("Calling updateReview with:", updatedReview);
        ...
        console.error("Cannot save: review is null");
      }
    } catch (err) {
